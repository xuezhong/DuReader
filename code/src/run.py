...
from joint_rc_model import MTRCModel
...
def parse_args():
    ...
    train_settings.add_argument('--epochs', type=int, default=10,
                                help='train epochs')
    train_settings.add_argument('--dev_interval', type=int, default=2000,
                                help='devalitation every n batches')
    ...
    model_settings.add_argument('--max_q_len', type=int, default=120,
    ...
    path_settings.add_argument('--embedding_path', default="./embed.pretrain",
...
def evaluate(args):
    ...
    #rc_model.restore(model_dir=args.model_dir, model_prefix="ema_temp")
...
def run():
    ...
    if os.path.exists(args.gpu):
        os.environ["CUDA_VISIBLE_DEVICES"] = open(args.gpu, 'rU').readline().strip()
    else:
