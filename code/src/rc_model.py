...
class RCModel(object):
    ...
    def _decode(self):
        ...
        with tf.variable_scope('same_question_concat'):
            ...
            concat_passage_mask = tf.reshape(
                self.passage_mask,
                [batch_size, -1]
            )
            ...
            no_dup_question_mask = tf.reshape(
                self.question_mask,
                [batch_size, -1]
            )
    ...
    def _train_epoch(self, train_batches, dropout_keep_prob, data, pad_id, batch_size):
        """
        ...
        for bitx, batch in enumerate(train_batches, 1):
            ...
            if self.dev_interval > 0 and bitx % self.dev_interval == 0:
    ...
    def train(self, data, epochs, batch_size, save_dir, save_prefix,
        ...
        for epoch in range(1, epochs + 1):
            ...
            train_loss = self._train_epoch(train_batches, dropout_keep_prob, data, pad_id, batch_size)
                    ...
                    if self.use_ema:
                        ...
                        with self.ema_test_graph.as_default():
                            if self.ema_test_model is None:
                                self.ema_test_model = RCModel(self.vocab, self.args)
    ...
    def restore(self, model_dir, model_prefix):
        ...
        self.logger.info('Model restored from {}'.format(os.path.join(model_dir, model_prefix)))
